...
public class Webtable_Using_keywords 
{
	...
	public static void main(String args[]) throws InterruptedException
	{
		...
		WebElement Cell=obj.Get_Static_Webtable_Cell("//div[@id='pnl_Bse']/table", 3, 3);
		String Record=Cell.getText();
		System.out.println(Record);
		
		//Get dynamic cell address
		WebElement News=obj.Get_Dynaic_Webtable_Cell("//div[@id='pnl_Bse']/table", "RELIND", 7);
		obj.click_element(News);
